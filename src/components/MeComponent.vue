<template>
  ...
  <div class="flex w-full">
    <div class="flex m-auto w-4/5">
      <spline-viewer class="mr-60 h-2/5" url="https://prod.spline.design/0-QULqF3MB8p6KT2/scene.splinecode"></spline-viewer>   
    </div>
  </div>
  <div class="flex w-full">
    <div class="absolute ml-60 mt-44 z-50">
      ...
      <div class="flex text-base text-white">
        희귀동물 입양/분양 커뮤니티 <div class="underline decoration-indigo-500">젊은</div>
